...
export default function Login() {
    ...
    useEffect(() => {
        if (admin) navigate("/app/dashboard");
    }, [admin, navigate]);
        ...
        <div className="h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-900 text-black dark:text-white">
            <div className="p-6 bg-white dark:bg-gray-800 rounded shadow w-80">
                ...
                <input
                    ...
                    className="border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-black dark:text-white p-2 w-full mb-3 rounded"
